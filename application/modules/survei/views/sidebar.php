  ...
  <div 
    ...
    >
            <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
              ...
              <li class="m-menu__item <?=$_SESSION['side']=='link'?'m-menu__item--active':''?>" aria-haspopup="true" >
                <a  href="<?php echo base_url();?>kues/link" class="m-menu__link ">
                  <i class="m-menu__link-icon flaticon-line-graph"></i>
                  <span class="m-menu__link-title">
                    <span class="m-menu__link-wrap">
                      <span class="m-menu__link-text">
              ...
              <li class="m-menu__item <?=$_SESSION['side']=='surv'?'m-menu__item--active':''?>" aria-haspopup="true" >
              ...
              <li class="m-menu__item <?=$_SESSION['side']=='gfkota'?'m-menu__item--active':''?>" aria-haspopup="true" >
                <a  href="<?php echo base_url();?>ikm/grafiksekota" class="m-menu__link ">
                  <i class="m-menu__link-icon flaticon-line-graph"></i>
                  <span class="m-menu__link-title">
                    <span class="m-menu__link-wrap">
                      <span class="m-menu__link-text">
