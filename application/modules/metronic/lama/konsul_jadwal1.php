...
<div class="row">
  <div class="col-xs-12">
    <h3 class="header smaller lighter blue">Jadwal konsultasi (Detail)</h3>
    <?php
    ...
    <tr><td>.</td></tr>
    <tr><td>
      <a href="<?php echo base_url() ?>dashboard/konsul_jadwal">
    ...
    <td>
      <a href="<?php echo base_url() ?>dashboard/add_konsul_jadwal/<?php echo $id;?>">
        ...
        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
          ...
          foreach ($content -> result_array() as $row): ?>
            <tr>
              ...
              <td><?php echo $row['konsul_ke']?></td>
              <td><?php echo $row['jadwal_konsul']?></td>
              <td><?php echo $row['materi']?></td>
              <td><?php echo $row['arahan']?></td>
              <td><?php echo $row['tanggapan_pd']?></td>

              <?php tambah($row['id'],'#',base_url().'dashboard/edit_konsul_jadwal1/'.$row['id'],base_url().'dashboard/delete_konsul_jadwal1/'.$id1.'/'.$row['id'],$row['materi']); ?>
            </tr>
    <?php endforeach ?>
