         ...
         <!-- Horizontal Form -->
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Input Data Visitasi</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
<?php foreach ($content -> result_array() as $key): ?>
              <form class="form-horizontal" action="<?php echo base_url(); ?>dashboard/action_update_visit_jadwal1/<?php echo $key['id_task']."/".$key['id'] ?>" method="post" accept-charset="utf-8">
              <div class="box-body">

                <div class="form-group">
                  <label class="col-sm-2 control-label">Visitasi ke</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="visitke" placeholder="Masukkan Data Visitasi ke berapa" value="<?php echo $key['visit_ke'] ?>">
                  </div>
                </div>

                <div class="form-group">
                  <label class="col-sm-2 control-label">Jadwal Visit</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="materi" placeholder="Masukkan Materi Visitasi" value="<?php echo $key['materi'] ?>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="arahan" placeholder="Masukkan Arahan Visitasi" value="<?php echo $key['arahan'] ?>">
                  </div>
                </div>
