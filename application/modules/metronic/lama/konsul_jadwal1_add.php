...
<?php foreach ($content -> result_array() as $key): ?>
              <form class="form-horizontal" action="<?php echo base_url(); ?>dashboard/action_add_konsul_jadwal1/<?php echo $key['id'] ?>" method="post" accept-charset="utf-8">
<?php endforeach ?>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="konsulke" placeholder="Masukkan Data konsultasi ke berapa">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <div class="input-group date">
                      ...
                      <input type="text" class="form-control pull-right" name="jadwal" id="datepicker">
                    </div>                  
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="materi" placeholder="Masukkan Materi konsultasi">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="arahan" placeholder="Masukkan Arahan konsultasi">
                  </div>
                </div>
