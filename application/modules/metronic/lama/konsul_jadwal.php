...
<div class="row">
  <div class="col-xs-12">
    <h3 class="header smaller lighter blue">Jadwal konsultasi</h3>
    <table>
    <tr>
      <td width="40">
          Tahun
    ...
    <?php
      $this->db->select('task.id,objek,jenis_task,evaluasi,tgl_create,tgl_update,is_selesai,nilai');
      $this->db->from('task');
          ...
          foreach ($content -> result_array() as $row): ?>
            <tr>
              ...
              <td><?php if($row['is_selesai']==1)
                ...
                <?php nilai('#',base_url().'dashboard/detail_konsul_jadwal/'.$row['id']); ?>
            </tr>
    <?php endforeach ?>
