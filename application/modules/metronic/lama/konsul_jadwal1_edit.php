...
<!-- Bootstrap 3.3.7 -->
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>assets/lte/bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css">
         ...
         <!-- Horizontal Form -->
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Input Data konsultasi</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
<?php foreach ($content -> result_array() as $key): ?>
              <form class="form-horizontal" action="<?php echo base_url(); ?>dashboard/action_update_konsul_jadwal1/<?php echo $key['id_task']."/".$key['id'] ?>" method="post" accept-charset="utf-8">
              <div class="box-body">

                <div class="form-group">
                  <label class="col-sm-2 control-label">konsultasi ke</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="konsulke" placeholder="Masukkan Data konsultasi ke berapa" value="<?php echo $key['konsul_ke'] ?>">
                  </div>
                </div>

                <div class="form-group">
                  <label class="col-sm-2 control-label">Jadwal konsul</label>
                  <div class="col-sm-10">
                    <div class="input-group date">
                      <div class="input-group-addon">
                        <i class="fa fa-calendar"></i>
                      </div>
                      <input type="text" class="form-control pull-right" name="jadwal" id="datepicker" value="
                      <?php 
                      $tgl=explode(' ',$key['jadwal_konsul']);
                      $tgl1=explode('-',$tgl[0]);
                      $tgl2=$tgl1[1].'/'.$tgl1[2].'/'.$tgl1[0].' '.$tgl[1];
                      echo ltrim(rtrim($tgl2));
                      ?>
                      ">
                    </div>                  
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="materi" placeholder="Masukkan Materi konsultasi" value="<?php echo $key['materi'] ?>">
                  </div>
                </div>

                <div class="form-group">
                  <label class="col-sm-2 control-label">Arahan</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="arahan" placeholder="Masukkan Arahan konsultasi" value="<?php echo $key['arahan'] ?>">
                  </div>
                </div>
...
<!-- bootstrap color picker -->
<script src="<?php echo base_url();?>assets/lte/bower_components/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js"></script>
<!-- bootstrap time picker -->
