...
<!-- Theme style -->
  ...
  <div class="col-xs-12">    
    ...
    <tr><td>
      <div class="col-xs-15">
        <a href="<?php echo base_url() ?>jenlay/jenlay_add/<?php echo $unlay ?>">
    ...
    <div class="callout callout-success">
      <font size="3">Daftar Jenis Layanan Per Unit Layanan </font>
    </div>
        ...
        <table class="table table-striped- table-bordered table-hover table-checkable responsive no-wrap" id="m_table_1">
          ...
          foreach ($content -> result_array() as $row): ?>
            <tr>
              ...
              <td><?php echo $row['jenis_layanan_diterima']?></td>
                <?php tambah($row['id'],'#',base_url().'jenlay/jenlay_edit/'.$row['id'],base_url().'jenlay/jenlay_delete/'.$row['id'],$row['jenis_layanan_diterima']); ?>
            </tr>
    <?php endforeach ?>
