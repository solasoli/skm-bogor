...
<div class="row">
  <div class="col-xs-12">
    <h3 class="header smaller lighter blue">Jadwal Visitasi (Detail)</h3>
    <?php
    ...
    <tr>
      ...
      <td width="1100">
            <textarea rows="2" class="form-control" disabled><?php echo $key['evaluasi'] ?></textarea>
      </td>
    </tr>
    </table>
    <?php 
    ...
    <tr><td>.</td></tr>
    <tr><td>
      <a href="<?php echo base_url() ?>dashboard/visit_jadwal">
        <button type="button" class="btn btn-block btn-info btn">Kembali</button>
      </a>
    </td>
    <td>.
    </td>
    <td>
      <a href="<?php echo base_url() ?>dashboard/add_visit_jadwal/<?php echo $id;?>">
        ...
        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
          ...
          foreach ($content -> result_array() as $row): ?>
            <tr>
              ...
              <td><?php echo $row['visit_ke']?></td>
              <td><?php echo $row['jadwal_visit']?></td>
              <td><?php echo $row['materi']?></td>
              <td><?php echo $row['arahan']?></td>
              <td><?php echo $row['tanggapan_pd']?></td>

              <?php tambah($row['id'],'#',base_url().'dashboard/edit_visit_jadwal1/'.$row['id'],base_url().'dashboard/delete_visit_jadwal1/'.$id1.'/'.$row['id'],$row['materi']); ?>
            </tr>
    <?php endforeach ?>
