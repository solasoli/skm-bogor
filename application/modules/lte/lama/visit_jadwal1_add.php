...
<?php foreach ($content -> result_array() as $key): ?>
              <form class="form-horizontal" action="<?php echo base_url(); ?>dashboard/action_add_visit_jadwal1/<?php echo $key['id'] ?>" method="post" accept-charset="utf-8">
<?php endforeach ?>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="visitke" placeholder="Masukkan Data Visitasi ke berapa">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="materi" placeholder="Masukkan Materi Visitasi">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="arahan" placeholder="Masukkan Arahan Visitasi">
                  </div>
                </div>
