...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo base_url();?>vendor/images/logo.png">

</head>
<body class="hold-transition login-page">
<div class="login-box">
  <div class="login-logo">
    <img src="<?php echo base_url();?>vendor/images/logo.png" width="60px" alt="User Image">&nbsp;&nbsp;<b>SKM</b>&nbsp;UnitLayanan
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="auth/validate" method="post">
      ...
      <div class="form-group has-feedback">
        <img src="<?php echo base_url();?>auth/captcha/" alt="Click for new image" title="Click for new image" style="cursor:pointer;float:left;width:150px;height:40px;" onclick="this.src='<?php echo base_url();?>auth/captcha/'+Math.random()">
...
<p></p>
  ...
  <!-- /.login-box-body -->
<div style="text-align:center;color:#756ff2"><p class="login-box-msg"> <br> Sistem Kepuasan Masyarakat Unit Layanan<br>
