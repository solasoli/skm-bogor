...
<div class="row">
  <div class="col-xs-12">
    <h3 class="header smaller lighter blue">Unit Layanan</h3>
    <table>
    <tr><td>.</td></tr>
    <tr><td>
      <a href="<?php echo base_url() ?>dashboard/unlay_add">
          ...
          foreach ($content -> result_array() as $row): ?>
            <tr>
              ...
              <td><?php echo $row['is_aktif']?></td>
                <?php tambah($row['id'],'#',base_url().'dashboard/edit_renev/'.$row['id'],base_url().'dashboard/delete_renev/'.$row['id'],$row['nama_unit']); ?>
            </tr>
    <?php endforeach ?>
