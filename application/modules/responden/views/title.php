...
<head>
  ...
  <link href="<?php echo base_url();?>assets/metronic5dflt/assets/vendors/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />
  <!--end::Base Styles -->
  ...
  <!--[if lt IE 9]>
  <script src="<?php echo base_url();?>assets/lte/https://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js"></script>
  <script src="<?php echo base_url();?>assets/lte/https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
  <![endif]-->

  <!-- Google Font -->
  <link rel="stylesheet" href="<?php echo base_url();?>assets/lte/https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">
...
<script src="<?php echo base_url();?>assets/lte/dist/js/demo.js"></script>
    ...
    <script type="text/javascript">
      if('ontouchstart' in document.documentElement) document.write("<script src='<?php echo base_url();?>assets/ace/assets/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");
    </script>
